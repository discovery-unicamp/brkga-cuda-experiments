...
BrkgaConfiguration::Builder& BrkgaConfiguration::Builder::generations(
    unsigned n) {
  _generations = n;
  return *this;
}

BrkgaConfiguration::Builder& BrkgaConfiguration::Builder::exchangeBestInterval(
    unsigned k) {
  _exchangeBestInterval = k;
  return *this;
}

BrkgaConfiguration::Builder& BrkgaConfiguration::Builder::exchangeBestCount(
    unsigned n) {
...
BrkgaConfiguration::Builder& BrkgaConfiguration::Builder::eliteProportion(
    float p) {
  if (p <= 0 || p >= 1)
...
BrkgaConfiguration::Builder& BrkgaConfiguration::Builder::mutantsProportion(
    float p) {
  if (p <= 0 || p >= 1)
